...
<?php
if($pagi!=1){
	echo "<a href='?pagi=1&str=$str'>First</a>&nbsp;&nbsp;";
	$prev=$pagi-1;
	echo "<a href='?pagi=$prev&str=$str'>Prev</a>&nbsp;&nbsp;";
}
...
for($i=1;$i<=$pagi_count;$i++){
	...
	echo "<a href='?pagi=$i&str=$str' class='$class'>$i</a>&nbsp;&nbsp;";
}

if($pagi!=$pagi_count){
	$next=$pagi+1;
	echo "<a href='?pagi=$next&str=$str'>Next</a>&nbsp;&nbsp;";
	echo "<a href='?pagi=$pagi_count&str=$str'>Last</a>&nbsp;&nbsp;";
}
